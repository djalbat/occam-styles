...
export default class RenameSelectedProjectsPathToolbarSVG extends ToolbarSVG {
  childElements() {
    return (

      <g transform="translate(0.5, 0) matrix(0.60361176,-0.60361176,0.60361176,0.60361176,-4.2838085,14.880864)">
