...
import { colour, tableColour, listingColour, headingColour, listItemColour, directiveColour } from "../../scheme/syntax/markdown";
...
const markdownSyntaxStyle = `
  ...
  .markdown.syntax > div > .list-item { color: ${listItemColour}; }
