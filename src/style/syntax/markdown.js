...
import { errorColour, commentColour, stringLiteralColour, errorTextDecorationColour } from "../../scheme/syntax/default";
...
const markdownSyntaxStyle = `
  ...
  .markdown.syntax > div > .string-literal { color: ${stringLiteralColour}; }
